        ...
        <div className="w-full max-w-7xl mx-auto">
            <div className="grid w-full justify-between sm:flex md:grid-cols-1">
                ...
                <Link
                    ...
                    <span className="px-2 py-1 bg-gradient-to-r from-blue-600 via-purple-700 to-pink-500 rounded-lg text-white">Divya's</span>
                    Blog
                </Link>
                </div>
            ...
            <div className="w-full sm:flex sm:items-center sm:justify-between">
                <Footer.Copyright href='#' by="Divya's Blog" year={new Date().getFullYear()}/> 
