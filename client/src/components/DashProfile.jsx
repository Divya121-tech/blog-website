import { Alert, Button, TextInput, Modal, ModalHeader, ModalBody} from 'flowbite-react';
...
export default function DashProfile() {
  ...
  useEffect(() =>{
    ...
    uploadTask.on(
      ...
      (error) => {
        setImageFileUploadError('could not upload image(File must be upload in 2MB)');
        ...
        <Modal.Header />
          <Modal.Body>
            <div className="text-center">
              ...
              <h3 className='mb-5 textlg text-gray-500 dark:text-gray-400'>Are you sure you want to delete your account</h3>
